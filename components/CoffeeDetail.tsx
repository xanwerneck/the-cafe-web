...
import CoffeeViewsTracker from "@/components/CoffeeViewsTracker";
import PageHeader from "@/components/PageHeader";
import { burnLevel, formatLabel } from "@/lib/coffeeDisplay";
import { coffeeDisplayTitle } from "@/lib/coffees/seo";
...
function BurnScale({ burn }: { burn?: number | string | null }) {
...
export default function CoffeeDetail({ coffee }: { coffee: Coffee }) {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-[#5e2a8b] pb-12">
      <CoffeeViewsTracker coffeeId={coffee.id} />
      <PageHeader />
